<li class="dd-item dd3-item @if ($row->reference_id > 0) post-item @endif" data-menu-item="{{ json_encode(apply_filters('menu_nodes_item_data', Arr::except($row->toArray(), ['created_at', 'updated_at', 'child']))) }}">
