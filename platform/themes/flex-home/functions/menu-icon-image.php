...
add_action(BASE_ACTION_AFTER_CREATE_CONTENT, 'save_addition_in_menu_node_fields', 170, 3);
add_action(BASE_ACTION_AFTER_UPDATE_CONTENT, 'save_addition_in_menu_node_fields', 170, 3);

function save_addition_in_menu_node_fields($type, $request, $object)
{
