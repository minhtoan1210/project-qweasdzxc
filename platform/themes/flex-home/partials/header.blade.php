...
<head>
    ...
    <!-- GG font Merriweather & Montserrat  -->
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
    <link
            href="https://fonts.googleapis.com/css2?family=Merriweather:wght@700&family=Montserrat:wght@300;400;500;600;700&display=swap"
            rel="stylesheet" />
    <!-- Font Awesome -->
...
<div class="bravo_topbar d-none d-sm-block" style="display: none !important;">
...
<header class="topmenu bg-light">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        @if (theme_option('logo'))
                            <a class="navbar-brand" href="{{ route('public.single') }}">
                                <img src="{{ RvMedia::getImageUrl('https://thomasnguyen.com.vn/storage/logo/logo-1.png')}}" style="max-height: 38px" alt="{{ theme_option('site_name') }}">
                            </a>
                        @endif
    ...
    @if (is_plugin_active('real-estate') && url()->current() == route('public.single') || ($page && $page->template === 'homepage'))
        ...
        @endphp
        <div class="home_banner" style="height: auto; background: white">
{{--            <div class="topsearch">--}}
{{--                @if (theme_option('home_banner_description'))<h1 class="text-center text-white mb-4 banner-text-description">{{ theme_option('hipome_banner_descrtion') }}</h1>@endif--}}
{{--            </div>--}}
            <div class="home__banner__img">
                <img src="{{ Theme::asset()->url('https://thomasnguyen.com.vn/storage/icon/banner-homepage.png') }}" alt="" srcset="">
            </div>
            <div class="home__banner__content">
                <div class="banner__title__item">
                    <h2 class="heading2__blue text-center">CHOOSE YOUR HOME</h2>
                </div>
                <div class="banner__title__item">
                    <h2 class="heading2__white">IN</h2>
                </div>
                <div class="banner__title__item">
                    <h2 class="heading2__gold">THOMAS NGUYEN</h2>
                </div>

                <div class="btn-contact">
                    <a href="#"><button class="btn btn-white">Contact us</button></a>
                </div>
                <div class="scroll__down">
                    <div class="scroll__item"> <img src="{{ Theme::asset()->url('https://thomasnguyen.com.vn/storage/icon/mouse.png') }}" alt="" srcset=""></div>
                    <div class="scroll__item">
                        <p class="para__white">Scroll down to see more</p>
                    </div>
                    <div class="scroll__item">
                        <img src="{{ Theme::asset()->url('https://thomasnguyen.com.vn/storage/icon/scroll-down.png') }}" alt="" srcset="">
                    </div>
                </div>
            </div>
        </div>
